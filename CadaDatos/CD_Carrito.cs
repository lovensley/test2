...
namespace CadaDatos
{
    ...
    {
        public List<Carrito> ListarProductoCarrito(int idcliente)
        {
        ...
        public int CantidadEnCarrito(int idcliente)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    SqlCommand cmd = new SqlCommand("select sum(Cantidad) from CARRITO where IdCliente=@IdCliente", oconexion);
                    cmd.Parameters.AddWithValue("@IdCliente", idcliente);
                    cmd.CommandType = CommandType.Text;
                    oconexion.Open();
